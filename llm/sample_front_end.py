...
class ChatApp(ctk.CTk):
    def __init__(self):
        ...
        self._add_message("assistant", f"Hi! I’m {ASSISTANT_NAME}. Ask me anything.", timestamp=True)
    ...
    def _add_message(self, role: str, text: str, timestamp: bool = False):
        ...
        try:
            ...
            pass  # safe fallback if internals change
    ...
    def on_send_click(self):
        ...
        reply = self.generate_llm_response(content)
        self._add_message("assistant", reply, timestamp=True)

    def generate_llm_response(self, user_text: str) -> str:
        response = self.llm.process_response(user_text)
        return response
