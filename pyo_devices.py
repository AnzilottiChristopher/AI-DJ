# # from pyo import pa_list_devices, Server

# # # print("Listing devices...")
# # # pa_list_devices()
# # # print("Done.")

# # s = Server(outdev=1, sr=44100, nchnls=2, buffersize=512, duplex=0).boot()
# # s.start()
# # print("Server started with output device:", s.getOutputDevice())
